...
public class CascadeShadow {
    ...
    public static void updateCascadeShadows(List<CascadeShadow> cascadeShadows, Camera activeCamera) {
        ...
        Vector4f lightPos = new Vector4f(0.5f, 0.5f, 0.5f, 0);//new Vector4f(scene.getSceneLights().getDirLight().getDirection(), 0);
