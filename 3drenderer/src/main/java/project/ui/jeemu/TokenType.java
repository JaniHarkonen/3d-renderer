...
public enum TokenType {
	...
	/**
	 * Token's value is a reserved property name (String) and will never be evaluable.
	 */
	PROPERTY,
	...
	/**
	 * Token's value is a reserved word (String) that is any literal whose usage is 
	 * restricted and will never be evaluable.
	 */
	RESERVED
}
